    ...
    return(
        <div className="md:grid grid-cols-4 bg-[#4ee8e2] py-15 px-5 lg:px-25 items-center">
            ...
            <div className="col-span-2 flex flex-col items-center justify-center gap-3">
                <h3 className="text-[#43687a] font-semibold text-center text-[35px]">Learn to code anywhere.</h3>
                <p className="text-[#43687a] text-center">Grasshopper is available on iOS, Android, and all web browsers. Your progress syncs seamlessly between devices.</p>
